      ...
      {idle && (
        <div style={{ width: '100%', marginTop: '34px', paddingBottom: 0 }}>
          <div style={{ marginBottom: '14px', textAlign: 'center' }}>
            ...
            <p style={{ fontFamily: MONO, fontSize: '11px', color: '#7a7a7a', margin: '6px 0 0 0', letterSpacing: '0.03em' }}>
              Curated list for demo vibes - score/cause generated by the same public GitHub signals.
            </p>
          </div>
