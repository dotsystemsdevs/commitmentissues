...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: 'https://commitmentissues.dev/about', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.5 },
    ...
    { url: 'https://commitmentissues.dev/refund', lastModified: new Date(), changeFrequency: 'yearly', priority: 0.2 },
  ]
}
